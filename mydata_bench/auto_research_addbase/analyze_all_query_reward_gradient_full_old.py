"""Full-scope original846 F7 description and unchanged strict point gate."""
import collections
import json
import pathlib
import yaml
...
def main():
    root = DEST/'all_query_reward_gradient_full_old_v1'
    ...
    report = ['# F7完整原始846条描述性结果', '', '**这是已暴露数据上的完整验收，不能当作独立确认。**', '',
